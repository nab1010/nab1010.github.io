...
Giải pháp là xây dựng pipeline từ nguồn (source) xuống bộ giải mã (demuxer), và đặt nó chạy (play). Khi demuxer nhận đủ thông tin để biết về số lượng và loại luồng trong container, nó sẽ bắt đầu tạo các source pads. Đây là lúc thích hợp để để chúng ta hoàn thành việc xây dựng pipeline và gắn nó vào các demuxer pads mới được thêm vào.
